...
Grab elements that I want- use CSS selector tool to locate element type, then add into code
...
same process, different data- alter request using query to get additional rows
